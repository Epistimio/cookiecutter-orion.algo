# -*- coding: utf-8 -*-
#
# orion.algo.{{ cookiecutter.plugin_name }} documentation build configuration file.
#
...
import orion.algo.{{ cookiecutter.plugin_name }} as algo_plugin
...
project = u'orion.algo.{{ cookiecutter.plugin_name }}'
...
latex_documents = [
  (master_doc, 'orion.algo.{{ cookiecutter.plugin_name}}.tex',
   u'Oríon algo {{ cookiecutter.plugin_name }} Documentation',
...
texinfo_documents = [
  (master_doc, '{{ cookiecutter.plugin_name }}',
   u'Oríon algo {{ cookiecutter.plugin_name }} Documentation',
   author, '{{ cookiecutter.plugin_name }}', algo_plugin.__descr__,
   'Miscellaneous'),
]
